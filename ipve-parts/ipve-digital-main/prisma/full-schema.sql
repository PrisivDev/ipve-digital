...
-- CreateEnum
CREATE TYPE "RoleName" AS ENUM ('ADMIN', 'TEACHER', 'ACCOUNTANT', 'CASHIER', 'SECRETARY', 'PARENT', 'STUDENT');

-- CreateEnum
CREATE TYPE "PermissionModule" AS ENUM ('CRM', 'ERP', 'LMS', 'SETTINGS', 'REPORTS');

-- CreateEnum
CREATE TYPE "PermissionAction" AS ENUM ('CREATE', 'READ', 'UPDATE', 'DELETE', 'EXPORT', 'VALIDATE');

-- CreateEnum
CREATE TYPE "ProspectSource" AS ENUM ('WEBSITE', 'RECOMMENDATION', 'SOCIAL_MEDIA', 'FACEBOOK', 'WHATSAPP', 'WALK_IN', 'EVENT', 'ADVERTISEMENT', 'PARTNER', 'OTHER');

-- CreateEnum
CREATE TYPE "ProspectStatus" AS ENUM ('NOUVEAU', 'CONTACTE', 'INTERESSE', 'DOSSIER_RECU', 'ADMIS', 'CONVERTI', 'ABANDONNE');

-- CreateEnum
CREATE TYPE "StudentStatus" AS ENUM ('ENROLLED', 'ACTIVE', 'SUSPENDED', 'GRADUATED', 'TRANSFERRED', 'DROPPED');

-- CreateEnum
CREATE TYPE "Gender" AS ENUM ('MALE', 'FEMALE');

-- CreateEnum
CREATE TYPE "EvaluationType" AS ENUM ('DEVOIR', 'COMPOSITION', 'TP', 'EXAMEN', 'PROJET', 'PARTICIPATION');

-- CreateEnum
CREATE TYPE "AttendanceStatus" AS ENUM ('PRESENT', 'ABSENT', 'LATE', 'EXCUSED', 'SUSPENDED');

-- CreateEnum
CREATE TYPE "DayOfWeek" AS ENUM ('MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'FRIDAY', 'SATURDAY');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CASH', 'MTN_MOMO', 'ORANGE_MONEY', 'WAVE', 'BANK_TRANSFER', 'CHEQUE');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'COMPLETED', 'PARTIALLY_REFUNDED', 'REFUNDED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "ExpenseStatus" AS ENUM ('PENDING', 'APPROVED', 'PAID', 'REJECTED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "JournalType" AS ENUM ('SALES', 'PURCHASES', 'BANK', 'CASH', 'OD', 'GENERAL');

-- CreateEnum
CREATE TYPE "ReferenceType" AS ENUM ('PAYMENT', 'EXPENSE', 'PAYROLL', 'ADJUSTMENT', 'INVOICE');
...
-- CreateEnum
CREATE TYPE "ContractType" AS ENUM ('CDI', 'CDD', 'INTERIM', 'FREELANCE', 'STAGE');

-- CreateEnum
CREATE TYPE "Department" AS ENUM ('DIRECTION', 'ACADEMIQUE', 'FINANCIER', 'ADMINISTRATIF', 'INFORMATIQUE');

-- CreateEnum
CREATE TYPE "PayrollStatus" AS ENUM ('DRAFT', 'PENDING_VALIDATION', 'VALIDATED', 'PAID', 'CANCELLED');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('INFO', 'SUCCESS', 'WARNING', 'ERROR', 'PAYMENT_REMINDER', 'GRADE_PUBLISHED', 'ABSENCE_ALERT');

-- CreateEnum
CREATE TYPE "AdmissionStatus" AS ENUM ('DRAFT', 'SUBMITTED', 'UNDER_REVIEW', 'ACCEPTED', 'REJECTED', 'CANCELLED', 'ENROLLED');

-- CreateEnum
CREATE TYPE "StudentCardStatus" AS ENUM ('ACTIVE', 'LOST', 'EXPIRED', 'CANCELLED');
...
-- CreateTable
CREATE TABLE "payment_plan_tranches" (
    "id" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "prospects_converted_student_id_key" ON "prospects"("converted_student_id");
...
-- CreateIndex
CREATE INDEX "prospects_assignedTo_idx" ON "prospects"("assignedTo");

-- CreateIndex
CREATE INDEX "prospects_phone_idx" ON "prospects"("phone");

-- CreateIndex
CREATE INDEX "prospects_last_contact_at_idx" ON "prospects"("last_contact_at");

-- CreateIndex
CREATE INDEX "prospect_interactions_prospect_id_idx" ON "prospect_interactions"("prospect_id");

-- CreateIndex
CREATE INDEX "prospect_interactions_type_idx" ON "prospect_interactions"("type");
...
-- CreateIndex
CREATE INDEX "students_filiere_id_idx" ON "students"("filiere_id");
...
-- CreateIndex
CREATE INDEX "filieres_code_idx" ON "filieres"("code");

-- CreateIndex
CREATE INDEX "filieres_is_active_idx" ON "filieres"("is_active");

-- CreateIndex
CREATE INDEX "levels_filiere_id_idx" ON "levels"("filiere_id");

-- CreateIndex
CREATE UNIQUE INDEX "levels_filiere_id_year_number_key" ON "levels"("filiere_id", "year_number");
...
-- CreateIndex
CREATE INDEX "periods_is_current_idx" ON "periods"("is_current");
...
-- CreateIndex
CREATE INDEX "grades_evaluation_type_idx" ON "grades"("evaluation_type");

-- CreateIndex
CREATE INDEX "grades_is_validated_idx" ON "grades"("is_validated");
...
-- CreateIndex
CREATE UNIQUE INDEX "attendance_student_id_class_id_subject_id_date_key" ON "attendance"("student_id", "class_id", "subject_id", "date");
...
-- CreateIndex
CREATE INDEX "payment_plans_level_id_idx" ON "payment_plans"("level_id");

-- CreateIndex
CREATE INDEX "payment_plans_academic_year_id_idx" ON "payment_plans"("academic_year_id");

-- CreateIndex
CREATE INDEX "payment_plans_level_id_academic_year_id_is_active_idx" ON "payment_plans"("level_id", "academic_year_id", "is_active");

-- CreateIndex
CREATE INDEX "payment_plan_tranches_plan_id_idx" ON "payment_plan_tranches"("plan_id");

-- CreateIndex
CREATE UNIQUE INDEX "payment_plan_tranches_plan_id_tranche_number_key" ON "payment_plan_tranches"("plan_id", "tranche_number");
...
-- CreateIndex
CREATE INDEX "payments_student_id_tranche_id_idx" ON "payments"("student_id", "tranche_id");

-- CreateIndex
CREATE INDEX "payments_tranche_id_status_idx" ON "payments"("tranche_id", "status");
...
-- CreateIndex
CREATE INDEX "chart_of_accounts_account_number_idx" ON "chart_of_accounts"("account_number");

-- CreateIndex
CREATE INDEX "chart_of_accounts_account_class_idx" ON "chart_of_accounts"("account_class");
...
-- CreateIndex
CREATE INDEX "journal_entries_journal_type_idx" ON "journal_entries"("journal_type");

-- CreateIndex
CREATE INDEX "journal_entries_reference_type_reference_id_idx" ON "journal_entries"("reference_type", "reference_id");

-- CreateIndex
CREATE INDEX "journal_entries_is_validated_idx" ON "journal_entries"("is_validated");
...
-- CreateIndex
CREATE INDEX "sync_log_table_name_record_id_idx" ON "sync_log"("table_name", "record_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "admissions_enrolled_student_id_key" ON "admissions"("enrolled_student_id");

-- CreateIndex
CREATE INDEX "admissions_status_idx" ON "admissions"("status");

-- CreateIndex
CREATE INDEX "admissions_filiere_id_idx" ON "admissions"("filiere_id");

-- CreateIndex
CREATE INDEX "admissions_level_id_idx" ON "admissions"("level_id");

-- CreateIndex
CREATE INDEX "admissions_phone_idx" ON "admissions"("phone");
...
-- CreateIndex
CREATE INDEX "student_cards_status_idx" ON "student_cards"("status");

-- CreateIndex
CREATE INDEX "student_cards_card_number_idx" ON "student_cards"("card_number");
...
-- AddForeignKey
ALTER TABLE "prospects" ADD CONSTRAINT "prospects_converted_student_id_fkey" FOREIGN KEY ("converted_student_id") REFERENCES "students"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "prospect_interactions" ADD CONSTRAINT "prospect_interactions_prospect_id_fkey" FOREIGN KEY ("prospect_id") REFERENCES "prospects"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "prospect_interactions" ADD CONSTRAINT "prospect_interactions_conducted_by_fkey" FOREIGN KEY ("conducted_by") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "students" ADD CONSTRAINT "students_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "students" ADD CONSTRAINT "students_filiere_id_fkey" FOREIGN KEY ("filiere_id") REFERENCES "filieres"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "levels" ADD CONSTRAINT "levels_filiere_id_fkey" FOREIGN KEY ("filiere_id") REFERENCES "filieres"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "grades" ADD CONSTRAINT "grades_subject_id_fkey" FOREIGN KEY ("subject_id") REFERENCES "class_subjects"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "grades" ADD CONSTRAINT "grades_validated_by_fkey" FOREIGN KEY ("validated_by") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "attendance" ADD CONSTRAINT "attendance_subject_id_fkey" FOREIGN KEY ("subject_id") REFERENCES "class_subjects"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "schedules" ADD CONSTRAINT "schedules_subject_id_fkey" FOREIGN KEY ("subject_id") REFERENCES "class_subjects"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "payment_plans" ADD CONSTRAINT "payment_plans_level_id_fkey" FOREIGN KEY ("level_id") REFERENCES "levels"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "payment_plans" ADD CONSTRAINT "payment_plans_academic_year_id_fkey" FOREIGN KEY ("academic_year_id") REFERENCES "academic_years"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "payment_plan_tranches" ADD CONSTRAINT "payment_plan_tranches_plan_id_fkey" FOREIGN KEY ("plan_id") REFERENCES "payment_plans"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "payments" ADD CONSTRAINT "payments_student_id_fkey" FOREIGN KEY ("student_id") REFERENCES "students"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "payments" ADD CONSTRAINT "payments_tranche_id_fkey" FOREIGN KEY ("tranche_id") REFERENCES "payment_plan_tranches"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "payroll_runs" ADD CONSTRAINT "payroll_runs_validated_by_fkey" FOREIGN KEY ("validated_by") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "sync_log" ADD CONSTRAINT "sync_log_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "admissions" ADD CONSTRAINT "admissions_filiere_id_fkey" FOREIGN KEY ("filiere_id") REFERENCES "filieres"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "admissions" ADD CONSTRAINT "admissions_level_id_fkey" FOREIGN KEY ("level_id") REFERENCES "levels"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "admissions" ADD CONSTRAINT "admissions_reviewed_by_fkey" FOREIGN KEY ("reviewed_by") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "admissions" ADD CONSTRAINT "admissions_enrolled_student_id_fkey" FOREIGN KEY ("enrolled_student_id") REFERENCES "students"("id") ON DELETE SET NULL ON UPDATE CASCADE;
